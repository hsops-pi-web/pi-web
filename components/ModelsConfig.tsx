...
function ModelDetail({
  ...
  const handleTest = useCallback(async () => {
    ...
    try {
      const res = await authFetch("/api/models-config/test", {
        method: "POST",
...
export function ModelsConfig({ onClose = () => undefined, embedded = false }: { onClose?: () => void; embedded?: boolean }) {
  ...
  return (
    ...
    <div style={{
      ...
      <div style={{
        ...
        minHeight: embedded ? 620 : undefined,
        background: "var(--bg)",
        border: "1px solid var(--border)",
