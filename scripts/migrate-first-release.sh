...
PRODUCTION_HOME=${PI_WEB_PRODUCTION_HOME:-/var/lib/pi-web-auth}
INSTALLED_UNIT=${PI_WEB_INSTALLED_UNIT:-/etc/systemd/system/pi-web-auth.service}
UNIT_TEMPLATE=${PI_WEB_UNIT_TEMPLATE:-$SOURCE_ROOT/systemd/pi-web-auth.service.example}
ENV_FILE=${PI_WEB_RELEASE_ENV:-/etc/pi-web-auth/release.env}
